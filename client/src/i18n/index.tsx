...
const translations: Record<Locale, Record<string, unknown>> = { ru, kk, en, uk, ka, az, uz, pl };
...
export function I18nProvider({ children }: { children: ReactNode }) {
  ...
  const locale = (['ru', 'kk', 'en', 'uk', 'ka', 'az', 'uz', 'pl'].includes(settings.language) ? settings.language : 'ru') as Locale;
