...
export function TutorialModal({ open, onClose, onStartTutorial, isLoading = false, isMandatory = false, onSkip }: TutorialModalProps) {
  ...
  const content = {
    ...
    ka: {
      ...
      subtitle: isMandatory ? 'თამაშის დაწყების გადი გაიარეთ მოစ6კლე სწავლება' : undefined,
      whatAwaits: 'რა გელოდეთ:',
      items: [
        '✓ თამის წესების სრული ახსნა',
        '✓ ყველა მექანიკის შესწავლა',
        '✓ ბოტთან ვარჯიში',
        '✓ შანირაკის დაკარგვის რისკის გარეშე',
        '✓ 2000 შანირაკი პირველი გავლისთვის',
      ],
      description: 'შევქმნით სპეციალურ სასწავლო ოთახს, სადაც შეგიძლიათ დურაკის ჩვენი ვერსიის ყველა ახალი მექანიკა და წესები. სწავლება დაახლობით აახლობით 5-10 წუთს.',
      cancel: 'გაუქმება',
      skip: 'სწავლების განვლება',
