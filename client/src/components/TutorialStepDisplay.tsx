  ...
  return (
    <>
      ...
      >
        ...
        {/* Desktop text */}
        {(() => {
          const localizedText = locale === 'kk' ? ((scenario as any).textKk || scenario.text) : locale === 'en' ? ((scenario as any).textEn || scenario.text) : locale === 'uk' ? ((scenario as any).textUk || scenario.text) : locale === 'ka' ? ((scenario as any).textKa || scenario.text) : locale === 'az' ? ((scenario as any).textAz || scenario.text) : locale === 'uz' ? ((scenario as any).textUz || scenario.text) : locale === 'pl' ? ((scenario as any).textPl || scenario.text) : scenario.text;
          const localizedMobileText = scenario.mobileText ? (locale === 'kk' ? ((scenario as any).mobileTextKk || scenario.mobileText) : locale === 'en' ? ((scenario as any).mobileTextEn || scenario.mobileText) : locale === 'uk' ? ((scenario as any).mobileTextUk || scenario.mobileText) : locale === 'ka' ? ((scenario as any).mobileTextKa || scenario.mobileText) : locale === 'az' ? ((scenario as any).mobileTextAz || scenario.mobileText) : locale === 'uz' ? ((scenario as any).mobileTextUz || scenario.mobileText) : locale === 'pl' ? ((scenario as any).mobileTextPl || scenario.mobileText) : scenario.mobileText) : null;
