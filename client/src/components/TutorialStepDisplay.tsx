    ...
    <>
      ...
      >
        <div className={`flex justify-between items-start ${(isCompact || isBottom) ? 'mb-1' : 'mb-3'}`}>
          <div>
            <h3 className={`font-bold text-yellow-400 ${isCompact ? 'text-sm sm:text-base mb-0' : isBottom ? 'text-xs sm:text-sm mb-0' : 'text-base sm:text-lg mb-0.5'}`}>{locale === 'kk' ? ((scenario as any).titleKk || scenario.title) : locale === 'en' ? ((scenario as any).titleEn || scenario.title) : locale === 'uk' ? ((scenario as any).titleUk || scenario.title) : scenario.title}</h3>
        ...
        {/* Desktop text */}
        {(() => {
          const localizedText = locale === 'kk' ? ((scenario as any).textKk || scenario.text) : locale === 'en' ? ((scenario as any).textEn || scenario.text) : locale === 'uk' ? ((scenario as any).textUk || scenario.text) : scenario.text;
          const localizedMobileText = scenario.mobileText ? (locale === 'kk' ? ((scenario as any).mobileTextKk || scenario.mobileText) : locale === 'en' ? ((scenario as any).mobileTextEn || scenario.mobileText) : locale === 'uk' ? ((scenario as any).mobileTextUk || scenario.mobileText) : scenario.mobileText) : null;
        ...
        {(() => {
          const localizedInstruction = locale === 'kk' ? ((scenario as any).instructionKk || scenario.instruction) : locale === 'en' ? ((scenario as any).instructionEn || scenario.instruction) : locale === 'uk' ? ((scenario as any).instructionUk || scenario.instruction) : scenario.instruction;
