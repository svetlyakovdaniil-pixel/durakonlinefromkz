...
const TUTORIAL_SCENARIOS: TutorialScenario[] = [
  ...
  },
  {
    ...
    textUz: 'Bu növbə taymerıdır. Hər oyunçunun növbəsi üçün müəyyən sayda saniyəsi var, bu hər otağın parametrlərində təyin edilir. Vaxt bitdikdə — növbə növbəti oyunçuya keçir.',
  ...
  },
  {
    ...
    textUz: 'Bu bito (vurulmuş kartlar) sayğacıdır. Oyundan neçə kartın çıxdığını göstərir.',
  ...
  },
  {
    ...
    textUz: 'Oyunda 2 dəstə kart istifadə olunur. Əvvəlcə bütün oyunçular arasında №1 dəstə oynanır. O bitdikdə №2 dəstə başlayır.',
  ...
  },
  {
    ...
    textUz: 'Kartları çeşidləmək üçün "Çeşidlə" düyməsini basın. Sayğac əldəki kartların sayını göstərir.',
    textPl: 'Naciśnij przycisk "Sortuj", aby posortować karty. Licznik pokazuje liczbę kart w ręce.',
    instruction: 'Нажмите "Далее" чтобы продолжить',
    instructionKk: '"Келесі" басыңыз',
    instructionEn: 'Click "Next" to continue',
    instructionUk: 'Натисніть "Далі" щоб продовжити',
    instructionAz: '"Çeşidlə" düyməsini basın',
    instructionUz: '"Çeşidlə" düyməsini basın',
  ...
  },
  {
    ...
    textUz: 'Bu koz kartıdır. Koz kartları digər maskaların kartlarını döyür. Koz maskanı yuxarıda görə bilərsiniz.',
    textPl: 'To jest karta atutowa. Karty atutowe biją karty innych kolorów. Aktualny atut widoczny jest u góry!',
  ...
  },
  {
    ...
    textUz: 'Siz hücum edirsiniz! Masaya kart atmaq üçün əlinizdəki yaşıl vurğulanmış karta basın.',
    textPl: 'Atakujesz! Naciśnij podświetloną zieloną kartę w ręce, aby zaatakować.',
    instruction: 'Нажмите "Далее" чтобы продолжить',
    instructionKk: '"Келесі" басыңыз',
    instructionEn: 'Click "Next" to continue',
    instructionUk: 'Натисніть "Далі" щоб продовжити',
    instructionAz: 'Yaşıl vurğulanmış karta basın',
    instructionUz: 'Yaşıl vurğulanmış karta basın',
    instructionPl: 'Naciśnij podświetloną zieloną kartę',
    playerHand: STANDARD_PLAYER_HAND,
    botHand: STANDARD_BOT_HAND,
    trumpSuit: 'hearts',
    trumpCard: 'Qh',
  ...
  },
  {
    ...
    textUz: 'İndi siz müdafiə edirsiniz! Masadakı kartı döymək üçün əlinizdəki uyğun karta basın.',
    textPl: 'Teraz się bronisz! Naciśnij odpowiednią kartę w ręce, aby pobić kartę na stole.',
    instruction: 'Нажмите "Далее" чтобы продолжить',
    instructionKk: '"Келесі" басыңыз',
    instructionEn: 'Click "Next" to continue',
    instructionUk: 'Натисніть "Далі" щоб продовжити',
    instructionAz: 'Masadakı kartı döyün',
    instructionUz: 'Masadakı kartı döyün',
    instructionPl: 'Pobij kartę na stole',
    playerHand: STANDARD_PLAYER_HAND,
    botHand: STANDARD_BOT_HAND,
    trumpSuit: 'hearts',
    requiredAction: 'click-button',
  ...
  },
  {
    ...
    textUz: 'Eyni nominallı kartlar (məsələn, iki yeddi) bir-birini döyür! Əgər onlar eyni nominaldırsa, kartı rəqibin kartının üstünə qoya bilərsiniz. Bu çox vacib qaydadır!',
    textPl: 'Karty o tej samej wartości (np. dwie siódemki) biją się nawzajem! Jeśli mają tę samą wartość, możesz położyć kartę na kartę przeciwnika. To bardzo ważna zasada!',
  ...
  },
  {
    ...
    textUz: 'Maça Padşahı (♠K) — oyundakı ən güclü kartdır! O, özündən başqa BÜTÜN kartları döyür. İki Maça Padşahı bir-birini döyə bilməz — bu heç-heçədir!',
    textPl: 'Król Pik (♠K) — to najsilniejsza karta w grze! Bije WSZYSTKIE karty oprócz siebie samego. Dwa Króle Pik nie mogą się nawzajem pobić — to remis!',
  ...
  },
  {
    ...
    titleUz: 'Pik Qirolini qanday urish mumkin',
    titlePl: 'Jak pobić Króla Pik',
    ...
    textUz: 'Maça Padşahını YALNIZ başqa Maça Padşahı ilə döymək olar. Heç bir başqa kart onu döyə bilməz, hətta koz belə! Bu oyundakı əsas istisnalardır.',
    textPl: 'Króla Pik można pobić TYLKO innym Królem Pik. Żadna inna karta go nie pobije, nawet atut! To główne wyjątki w grze.',
  ...
  },
  {
    ...
    textUz: '777 kartının xüsusi mexanikası var: o, ötürmə kartı kimi istifadə edilə bilər (kart götürmək əvəzinə növbəni başqa oyunçuya ötürmək).',
    textPl: 'Karta 777 ma specjalną mechanikę: może być użyta jako karta przekazania (zamiast brać karty, przekazuje turę innemu graczowi).',
  ...
  },
  {
    ...
    textUz: 'Ötürmə kartı masadan kart götürmək əvəzinə növbəni başqa oyunçuya ötürməyə imkan verir. Bu 777 və ya otağın qaydalarına görə digər kartlar ola bilər.',
    textPl: 'Karta przekazania pozwala przekazać turę innemu graczowi zamiast brać karty ze stołu. Może to być 777 lub inne karty zgodnie z zasadami pokoju.',
    ...
    instructionUz: '"Ötür" düyməsini basın',
    instructionPl: 'Naciśnij przycisk "Przekaż"',
    playerHand: STANDARD_PLAYER_HAND,
    botHand: STANDARD_BOT_HAND,
    trumpSuit: 'hearts',
    trumpCard: 'Qh',
  ...
  },
  {
    ...
    textUz: 'Proezdnoy kartı növbəni ötürməyə və masadan kart götürməməyə imkan verir. Proezdnoy kartdan sonra növbə növbəti oyunçuya keçir.',
    textPl: 'Karta proezdnoy pozwala przekazać turę i nie brać kart ze stołu. Po karcie proezdnoy tura przechodzi do następnego gracza.',
    instruction: 'Нажмите "Далее" чтобы продолжить',
    instructionKk: '"Келесі" басыңыз',
    instructionEn: 'Click "Next" to continue',
    instructionUk: 'Натисніть "Далі" щоб продовжити',
  ...
  },
  {
    ...
    textUz: '6 kartının xüsusi hərəkəti var: o, müəyyən kombinasiyalar və strategiyalar üçün istifadə edilə bilər. Bu kartı yadda saxlayın!',
    textPl: 'Karta 6 ma specjalny ruch: może być używana do określonych kombinacji i strategii. Zapamiętaj tę kartę!',
    instruction: 'Нажмите "Далее" чтобы продолжить',
    instructionKk: '"Келесі" басыңыз',
    instructionEn: 'Click "Next" to continue',
    instructionUk: 'Натисніть "Далі" щоб продовжити',
  ...
  },
  {
    ...
    textUz: '10 kartı — Maça Padşahından sonra ikinci ən güclü kartdır! O, Maça Padşahı və başqa 10-dan başqa bütün kartları döyür. Bu çox güclü kartdır!',
    textPl: 'Karta 10 — to druga najsilniejsza karta po Królu Pik! Bije wszystkie karty oprócz Króla Pik i innej 10. To bardzo silna karta!',
    instruction: 'Нажмите "Далее" чтобы продолжить',
    instructionKk: '"Келесі" басыңыз',
    instructionEn: 'Click "Next" to continue',
    instructionUk: 'Натисніть "Далі" щоб продовжити',
  ...
  },
  {
    ...
    textUz: 'Koz kartlarının xüsusi gücü var. Onlar müəyyən vəziyyətlərdə digər maskaların kartlarını döyə bilər. Yuxarıdakı kozlara baxın — bu oyunun cari kozudur!',
    textPl: 'Karty atutowe mają specjalną moc. W określonych sytuacjach mogą bić karty innych kolorów. Spójrz na atuty u góry — to aktualny atut w grze!',
    instruction: 'Нажмите "Далее" чтобы продолжить',
    instructionKk: '"Келесі" басыңыз',
    instructionEn: 'Click "Next" to continue',
    instructionUk: 'Натисніть "Далі" щоб продовжити',
  ...
  },
  {
    ...
    titleUz: '10 ga proezdnoy qoʼllaniladi',
    ...
    textUz: 'Hücum zamanı masaya bir neçə kart ata bilərsiniz. Eyni nominallı kartları atın — bu rəqibin müdafiəsini çətinləşdirir!',
    textPl: 'Podczas ataku możesz rzucić kilka kart na stół. Rzucaj karty o tej samej wartości — utrudnia to obronę przeciwnika!',
    instruction: 'Нажмите "Далее" чтобы продолжить',
    instructionKk: '"Келесі" басыңыз',
    instructionEn: 'Click "Next" to continue',
    instructionUk: 'Натисніть "Далі" щоб продовжити',
    instructionAz: 'Yaşıl kartları masaya atın',
    instructionUz: 'Yaşıl kartları masaya atın',
    instructionPl: 'Połóż zielone karty na stole',
    playerHand: STANDARD_PLAYER_HAND,
    botHand: STANDARD_BOT_HAND,
    trumpSuit: 'hearts',
    trumpCard: 'Qh',
  ...
  // Step 19: 6-ка вне очереди
  {
    ...
    textUz: 'Oyun başa çatdıqda son oyunçu "Axmaq" adlanır. Hər oyunun məqsədi əlinizdəki bütün kartlardan xilas olmaqdır!',
    textPl: 'Gdy gra się skończy, ostatni gracz z kartami zostaje "Durakiem". Celem każdej gry jest pozbycie się wszystkich kart z ręki!',
  ...
  // Step 20: Подкидывание 6-ок
  {
    ...
    textUz: 'Oyunçular saat əqrəbi istiqamətində növbə ilə hücum edirlər. Müdafiəçi kartları döydükdən sonra hücumçu dəyişir.',
    textPl: 'Gracze atakują na zmianę zgodnie z ruchem wskazówek zegara. Po tym jak obrońca pobije karty, atakujący się zmienia.',
  ...
  // Step 21: Потайной козырь
  {
    ...
    textUz: 'İlk hücumçu masaya 13-ə qədər kart ata bilər! Sonrakı turlarda kart sayı müdafiəçinin əlindəki kart sayı ilə məhdudlaşır.',
    textPl: 'Pierwszy atakujący może rzucić na stół do 13 kart! W kolejnych turach liczba kart jest ograniczona liczbą kart w ręce obrońcy.',
  ...
  // Step 22: Потайной козырь №1 — колода 1 закончилась, козырь сменился на крести
  {
    ...
    textUz: 'Güclü kartlarınızı saxlayın! Zəif kartlarla hücum edin, güclü kartları müdafiə üçün saxlayın. Rəqibinizin əlindəki kart sayını izləyin.',
    textPl: 'Zachowaj mocne karty! Atakuj słabymi kartami, zachowuj mocne do obrony. Obserwuj liczbę kart w ręce przeciwnika.',
  ...
  // Step 23: Потайной козырь №2 — обе колоды закончились, козырь буби
  {
    ...
    textUz: 'Siz öyrədicini tamamladınız! İndi real oyunçulara qarşı oynamağa hazırsınız. Uğurlar!',
    textPl: 'Ukończyłeś samouczek! Jesteś teraz gotowy grać przeciwko prawdziwym graczom. Powodzenia!',
    ...
    instructionUz: 'Öyrədicini bitir',
