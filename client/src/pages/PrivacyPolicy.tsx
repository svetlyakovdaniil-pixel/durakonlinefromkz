    ...
    <>
      <section>
        ...
        <p className="text-muted-foreground leading-relaxed">
          Настоящая Политика конфиденциальности определяет порядок обработки и защиты персональных данных пользователей мобильного приложения «Казахский Дурак Онлайн» (далее — «Приложение»). Используя Приложение, вы соглашаетесь с условиями данной Политики.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-muted-foreground leading-relaxed">
          Мы не продаём, не обмениваем и не передаём ваши персональные данные третьим лицам, за исключением случаев, предусмотренных законодательством Республики Казахстан, или когда это необходимо для предоставления услуг (например, хостинг-провайдеры, платёжные системы).
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-muted-foreground leading-relaxed">
          По всем вопросам, связанным с обработкой персональных данных, вы можете обратиться к нам через раздел «Жалобы» в Приложении или по электронной почте.
        </p>
      </section>
    </>
  );
  ...
  return (
    <>
      <section>
        ...
        <p className="text-muted-foreground leading-relaxed">
          Осы Құпиялылық саясаты «Қазақ Дурак Онлайн» мобильді қосымшасын (бұдан әрі — «Қосымша») пайдаланушылардың дербес деректерін өңдеу және қорғау тәртібін анықтайды. Қосымшаны пайдалана отырып, сіз осы Саясаттың шарттарымен келісесіз.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-muted-foreground leading-relaxed">
          Біз сіздің дербес деректеріңізді үшінші тараптарға сатпаймыз, алмастырмаймыз және бермейміз, Қазақстан Республикасының заңнамасында көзделген жағдайларды немесе қызметтерді ұсыну үшін қажет болған жағдайларды (мысалы, хостинг-провайдерлер, төлем жүйелері) қоспағанда.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-muted-foreground leading-relaxed">
          Дербес деректерді өңдеуге байланысты барлық сұрақтар бойынша Қосымшадағы «Шағымдар» бөлімі арқылы немесе электрондық пошта арқылы бізге хабарласа аласыз.
        </p>
      </section>
    </>
  );
