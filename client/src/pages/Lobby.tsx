...
onClick={() => setShowTengeTopUp(true)}
      ...
      {/* ===== BOTTOM TAB BAR ===== */}
      <div
        className={`fixed bottom-0 left-0 right-0 z-40 sm:hidden transition-opacity duration-200 ${showSeason || showPremium || showDailyQuests || showAchievements || showFriends || showLeaderboard ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}
        style={{
