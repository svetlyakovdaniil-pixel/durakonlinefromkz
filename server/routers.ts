      ...
      .query(async ({ input }) => {
        ...
        return all
          ...
          .map(a => ({
            ...
            nameKk: a.nameKk,
            nameEn: a.nameEn,
            nameUk: (a as any).nameUk,
            nameKa: (a as any).nameKa,
            nameAz: (a as any).nameAz,
            nameUz: (a as any).nameUz,
            namePl: (a as any).namePl,
            descRu: a.descRu,
            descKk: a.descKk,
            descEn: a.descEn,
            descUk: (a as any).descUk,
            descKa: (a as any).descKa,
            descAz: (a as any).descAz,
            descUz: (a as any).descUz,
            descPl: (a as any).descPl,
            icon: a.icon,
            category: a.category,
            reward: a.reward,
