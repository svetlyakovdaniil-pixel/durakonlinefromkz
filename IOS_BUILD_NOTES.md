...
4. Заполнить поля:
   ...
   - **Build number** — номер сборки (каждый раз увеличивать на 1; последняя успешная сборка была **24**, следующая **25**)
...
|-------|--------|---------|------|--------|
| #41   | 1.0.2  | 24      | 2026-06-22 | ✅ Success |
...
- `ios-build.yml` — теперь тоже использует `macos-26`, но предназначен для автоматических сборок при пуше в main
