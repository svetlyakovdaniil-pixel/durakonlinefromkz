...
- Последняя успешная загрузка: **1.0.49 (Build 55)** — Run #54
- **Следующий Build # = 56**
- **Следующая версия = 1.0.50** (или выше)
...
|-------|--------|---------|------|--------|------------|
| #54   | 1.0.49 | 55      | 2026-06-25 | ✅ Uploaded | Убрана синяя полоса снизу (safe-area padding в player-hand-area) |
| #53   | 1.0.48 | 54      | 2026-06-25 | ✅ Uploaded | ProfileDrawer полноэкранный, кнопки закрытия исправлены |
| #52   | 1.0.47 | 53      | 2026-06-25 | ✅ Uploaded | Sheet → модальные окна (Profile, Friends, Leaderboard, Settings) |
