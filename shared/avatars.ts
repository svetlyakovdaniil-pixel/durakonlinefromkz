...
export const AVATAR_OPTIONS: AvatarOption[] = [
  ...
  // Season 6 — Казахский колорит (Ruby)
  {
    ...
    nameEn: 'Steppe Ruby',
    url: 'ruby_kazakh',
    previewUrl: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663508367403/gxeBaGYcbqtwBaadFUobUt/ruby_kazakh_v3_49409013.png',
    animated: true,
    seasonReward: true,
  ...
  // Season 7 — Неоновая эра (Ruby)
  {
    ...
    nameEn: 'Neon Ruby',
    url: 'ruby_neon_era',
    previewUrl: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663508367403/gxeBaGYcbqtwBaadFUobUt/ruby_neon_era_v3_42502a8f.png',
    animated: true,
    seasonReward: true,
    seasonRankRequired: 'steppe_khan',
    seasonNumber: 7,
  ...
  // Season 8 — Апокалипсис (Ruby)
  {
    ...
    url: 'ruby_apocalypse',
    previewUrl: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663508367403/gxeBaGYcbqtwBaadFUobUt/ruby_apocalypse_final_791c8b8e.png',
    animated: true,
    seasonReward: true,
    seasonRankRequired: 'steppe_khan',
    seasonNumber: 8,
  ...
  // Season 9 — Японские мотивы (Ruby)
  {
    ...
    nameEn: 'Sakura Ruby',
    url: 'ruby_japanese',
    previewUrl: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663508367403/gxeBaGYcbqtwBaadFUobUt/ruby_japanese_v2_ed9fc656.png',
    animated: true,
    seasonReward: true,
    seasonRankRequired: 'steppe_khan',
    seasonNumber: 9,
  ...
  // Season 6 — Казахский колорит (Amber)
  {
    ...
    nameEn: 'Steppe Amber',
    url: 'amber_kazakh',
    previewUrl: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663508367403/gxeBaGYcbqtwBaadFUobUt/amber_kazakh_s6_v2_675d657a.png',
    animated: true,
    seasonReward: true,
  ...
  // Season 7 — Неоновая эра (Amber)
  {
    ...
    nameEn: 'Neon Amber',
    url: 'amber_neon_era',
    previewUrl: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663508367403/gxeBaGYcbqtwBaadFUobUt/amber_neon_era_s7_v2_434a2768.png',
    animated: true,
    seasonReward: true,
    seasonRankRequired: 'golden_horde_warrior',
    seasonNumber: 7,
  ...
  // Season 8 — Апокалипсис (Amber)
  {
    ...
    previewUrl: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663508367403/gxeBaGYcbqtwBaadFUobUt/amber_apocalypse_s8_96da3687.png',
    animated: true,
    seasonReward: true,
    seasonRankRequired: 'golden_horde_warrior',
    seasonNumber: 8,
  ...
  // Season 9 — Японские мотивы (Amber)
  {
    ...
    nameEn: 'Sakura Amber',
    url: 'amber_japanese',
    previewUrl: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663508367403/gxeBaGYcbqtwBaadFUobUt/amber_japanese_s9_11a4e751.png',
    animated: true,
    seasonReward: true,
    seasonRankRequired: 'golden_horde_warrior',
    seasonNumber: 9,
  ...
  // Season 6 — Казахский колорит (Obsidian)
  {
    ...
    url: 'obsidian_kazakh',
    previewUrl: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663508367403/gxeBaGYcbqtwBaadFUobUt/obsidian_kazakh_v2-CwSTTzwCooxU3Z7eSWybpy.webp',
    animated: true,
    seasonReward: true,
    seasonRankRequired: 'great_khan',
    seasonNumber: 6,
  ...
  // Season 7 — Неоновая эра (Obsidian)
  {
    ...
    previewUrl: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663508367403/gxeBaGYcbqtwBaadFUobUt/obsidian_neon_era_v2-adGE4hKxxPSNzmcWxb3qZE.webp',
    animated: true,
    seasonReward: true,
    seasonRankRequired: 'great_khan',
    seasonNumber: 7,
  ...
  },
  {
    ...
    url: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663508367403/gxeBaGYcbqtwBaadFUobUt/kitsune_emerald_4eb0f364.webp',
    premium: true,
    price: 25,
  },
  {
    ...
    nameKk: 'Айдахар (Рю)',
    nameEn: 'Dragon (Ryu)',
    url: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663508367403/gxeBaGYcbqtwBaadFUobUt/dragon_ryu_sapphire_47630a0e.webp',
    premium: true,
    price: 25,
  },
  {
