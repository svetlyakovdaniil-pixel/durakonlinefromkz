...
export const AVATAR_OPTIONS: AvatarOption[] = [
  ...
  },
  {
    id: 'cat_panic',
    name: 'Кот в панике',
    nameKk: 'Дүрбелеңдегі мысық',
    nameEn: 'Panic Cat',
    nameUk: 'Кіт у паніці',
    nameKa: 'პანიკაში მყოფი კატა',
    nameAz: 'Panikadakı pişik',
    nameUz: 'Vahimadagi mushuk',
    namePl: 'Kot w panice',
    url: '/assets/static/avatar-cat-panic.webp',
    premium: true,
    price: 50,
  },
  {
    ...
    name: 'Хитрый енот',
    nameKk: 'Қу жанат',
    nameEn: 'Clever Raccoon',
    nameUk: 'Хитрий єнот',
    nameKa: 'მოხერხებული ენოტი',
    nameAz: 'Hiyləgər yenot',
    nameUz: 'Ayyor yenot',
    namePl: 'Sprytny szop',
    url: '/assets/static/avatar-clever-raccoon.webp',
    premium: true,
    price: 50,
  },
  {
    ...
    nameKk: 'Изумруд көз',
    nameEn: 'Emerald Eye',
    nameUk: 'Смарагдове око',
    nameKa: 'ზურმუხტის თვალი',
    nameAz: 'Zümrüd gözü',
    nameUz: 'Zumrad ko‘z',
    namePl: 'Szmaragdowe oko',
    url: '/assets/static/avatar-emerald-eye.webp',
    premium: true,
    price: 50,
  },
  {
    ...
    nameKk: 'Көңілді қаз',
    nameEn: 'Happy Goose',
    nameUk: 'Веселий гусак',
    nameKa: 'მხიარული ბატი',
    nameAz: 'Şən Qaz',
    nameUz: 'Baxtli Gʻoz',
    namePl: 'Wesoła Gęś',
  ...
  },
  {
    ...
    nameKk: 'Дала бүркіті',
    nameEn: 'Steppe Eagle',
    nameUk: 'Беркут степів',
    nameKa: 'სტეპის ბერკუტი',
    nameAz: 'Çöl Berkutu',
    nameUz: 'Dasht Burguti',
    namePl: 'Orzeł Stepowy',
  ...
  },
  {
    ...
    nameEn: 'Neon Dino',
    nameUk: 'Неоновий динозавр',
    nameKa: 'ნეონური დინოზავრი',
    nameAz: 'Neon Dinozavr',
    nameUz: 'Neon Dino',
    namePl: 'Neonowy Dino',
  ...
  },
  {
    ...
    nameKk: 'Уытты дауыл',
    nameEn: 'Toxic Storm',
    nameUk: 'Токсична буря',
    nameKa: 'ტოქსიკური ქარიშხალი',
    nameAz: 'Toksik Fırtına',
    nameUz: 'Toksik Boʻron',
    namePl: 'Toksyczna Burza',
  ...
  },
  {
    ...
    nameUk: 'Ядерний гриб',
    nameKa: 'ბირთვული სოკო',
    nameAz: 'Nüvə Göbələyi',
    nameUz: 'Yadro Zamburugʻi',
    namePl: 'Nuklearny Grzyb',
  ...
  // Season 1 — Подводный мир (Zircon)
  {
    ...
    nameUk: 'Медуза безодні',
    nameKa: 'უფსკრულის მედუზა',
    nameAz: 'Dərin Meduza',
    nameUz: 'Tubsizlik Meduzi',
    namePl: 'Meduza Otchłani',
  ...
  // Season 3 — Пиратские острова (Zircon)
  {
    ...
    nameUk: 'Піратський капітан',
    nameKa: 'პირატი კაპიტანი',
    nameAz: 'Pirat Kapitan',
    nameUz: 'Qaroqchi Kapitan',
    namePl: 'Kapitan Piratów',
  ...
  // Season 4 — Скандинавские боги (Zircon)
  {
    ...
    nameEn: 'Norse God',
    nameUk: 'Скандинавський бог',
    nameKa: 'სკანდინავიური ღმერთი',
    nameAz: 'İskandinav Allahı',
    nameUz: 'Skandinav Xudosi',
    namePl: 'Nordycki Bóg',
  ...
  // Season 5 — Космическая одиссея (Zircon)
  {
    ...
    nameUk: 'Космічний мандрівник',
    nameKa: 'კოსმოსური მოხეტიალე',
    nameAz: 'Kosmik Səyyah',
    nameUz: 'Kosmik Tadqiqotchi',
    namePl: 'Odkrywca Kosmosu',
  ...
  // Season 10 — Киберпанк (Zircon)
  {
    ...
    nameUk: 'Кіберпанк воїн',
    nameKa: 'Cyberpunk Warrior',
    nameAz: 'Cyberpunk Döyüşçüsü',
    nameUz: 'Kiberpank Jangchisi',
    namePl: 'Wojownik Cyberpunk',
  ...
  // Season 11 — Хип-хоп 90-х (Zircon)
  {
    ...
    nameUk: 'Легенда хіп-хопу',
    nameKa: 'Hip-Hop Legend',
    nameAz: 'Hip-Hop Əfsanəsi',
    nameUz: 'Hip-Hop Afsonasi',
    namePl: 'Legenda Hip-Hopu',
  ...
  // Season 12 — Ангелы и Демоны (Zircon)
  {
    ...
    nameEn: 'Angel & Demon',
    nameUk: 'Ангел і демон',
    nameKa: 'Angel & Demon',
    nameAz: 'Mələk & Şeytan',
    nameUz: 'Farishta va Jin',
    namePl: 'Anioł i Demon',
  ...
  // Season 1 — Подводный мир (Ruby / steppe_khan)
  {
    ...
    nameUk: 'Повелитель глибин',
    nameKa: 'Ruler of the Deep',
    nameAz: 'Dərinliyin Hökmdarı',
    nameUz: 'Chuqurlik Hukmdori',
    namePl: 'Władca Głębin',
  ...
  // Season 2 — Египетские боги (Ruby / steppe_khan)
  {
    ...
    nameUk: 'Охоронець пірамід',
    nameKa: 'Guardian of Pyramids',
    nameAz: 'Ehramların Qoruyucusu',
    nameUz: 'Piramidallar Qoʻriqchisi',
    namePl: 'Strażnik Piramid',
  ...
  // Season 3 — Пиратские острова (Ruby / steppe_khan)
  {
    ...
    nameUk: 'Грізний пірат',
    nameKa: 'Fearsome Pirate',
    nameAz: 'Qorxunc Pirat',
    nameUz: 'Dahshatli Qaroqchi',
    namePl: 'Groźny Pirat',
  ...
  // Season 4 — Скандинавские боги (Ruby / steppe_khan)
  {
    ...
    nameUk: 'Воїн Одіна',
    nameKa: 'ოდინის მეომარი',
    nameAz: 'Odinin Döyüşçüsü',
    nameUz: 'Yulduz Qoʻriqchisi',
    namePl: 'Gwiezdny Strażnik',
    url: 'ruby_norse_gods',
  ...
  // Season 5 — Космическая одиссея (Ruby / steppe_khan)
  {
    ...
    nameUk: 'Зоряний страж',
    nameKa: 'Star Guardian',
    nameAz: 'Ulduz Qoruyucu',
    nameUz: 'Kiber Xaker',
    namePl: 'Cyber Haker',
  ...
  // Season 10 — Киберпанк (Ruby / steppe_khan)
  {
    ...
    nameKa: 'Cyber Hacker',
    nameAz: 'Kiber Haker',
    nameUz: 'Koʻcha Afsonasi',
    namePl: 'Legenda Ulicy',
    url: 'ruby_cyberpunk',
  ...
  // Season 11 — Хип-хоп 90-х (Ruby / steppe_khan)
  {
    ...
    nameUk: 'Легенда вулиць',
    nameKa: 'Street Legend',
    nameAz: 'Küçə Əfsanəsi',
    nameUz: 'Ikki Dunyo Qoʻriqchisi',
    namePl: 'Strażnik Dwóch Światów',
    url: 'ruby_hiphop_90s',
  ...
  // Season 12 — Ангелы и Демоны (Ruby / steppe_khan)
  {
    ...
    nameUk: 'Страж двох світів',
    nameKa: 'Guardian of Two Worlds',
    nameAz: 'İki Dünyanın Qoruyucusu',
    nameUz: 'Dengiz Hukmdori',
    namePl: 'Pan Morza',
  ...
  // Season 1 — Подводный мир (Amber / golden_horde_warrior)
  {
    ...
    nameKk: 'Теңіз иесі',
    nameEn: 'Sea Lord',
    nameUk: 'Морський владика',
    nameKa: 'Sea Lord',
    nameAz: 'Dəniz Ağası',
    nameUz: 'Xudolar Firʻavni',
    namePl: 'Faraon Bogów',
  ...
  // Season 2 — Египетские боги (Amber / golden_horde_warrior)
  {
    ...
    nameUk: 'Фараон богів',
    nameKa: 'Pharaoh of Gods',
    nameAz: 'Allahların Fironı',
    nameUz: 'Oltin Kapitan',
    namePl: 'Złoty Kapitan',
  ...
  // Season 3 — Пиратские острова (Amber / golden_horde_warrior)
  {
    ...
    nameUk: 'Золотий капітан',
    nameKa: 'Golden Captain',
    nameAz: 'Qızıl Kapitan',
    nameUz: 'Run Ustasi',
    namePl: 'Mistrz Run',
  ...
  // Season 4 — Скандинавские боги (Amber / golden_horde_warrior)
  {
    ...
    nameKk: 'Рун иесі',
    nameEn: 'Rune Master',
    nameUk: 'Повелитель рун',
    nameKa: 'Rune Master',
    nameAz: 'Run Ustası',
    nameUz: 'Kosmik Qoʻmondon',
    namePl: 'Kosmiczny Dowódca',
  ...
  // Season 5 — Космическая одиссея (Amber / golden_horde_warrior)
  {
    ...
    nameUk: 'Космічний командор',
    nameKa: 'Space Commander',
    nameAz: 'Kosmik Komandan',
    nameUz: 'Kiber Elita',
    namePl: 'Cyber Elita',
  ...
  // Season 11 — Хип-хоп 90-х (Amber / golden_horde_warrior)
  {
    ...
    nameKa: 'Golden MC',
    nameAz: 'Qızıl MC',
    nameUz: 'Muvozanat Saqlochi',
    namePl: 'Strażnik Równowagi',
  ...
  // Season 12 — Ангелы и Демоны (Amber / golden_horde_warrior)
  {
    ...
    nameUk: 'Охоронець балансу',
    nameKa: 'Balance Keeper',
    nameAz: 'Tarazlıq Qoruyucusu',
    nameUz: 'Tubsizlik Hukmdori',
    namePl: 'Władca Otchłani',
  ...
  // Season 1 — Подводный мир (Obsidian / great_khan)
  {
    ...
    nameUk: 'Владика безодні',
    nameKa: 'Abyss Overlord',
    nameAz: 'Uçurum Hökmdarı',
    nameUz: 'Zulmat Anubisi',
    namePl: 'Anubis Ciemności',
  ...
  // Season 2 — Египетские боги (Obsidian / great_khan)
  {
    ...
    nameUk: 'Анубіс Темряви',
    nameKa: 'Anubis of Darkness',
    nameAz: 'Qaranlığın Anubisi',
    nameUz: 'Arvoh Admiral',
    namePl: 'Admirał Duchów',
  ...
  // Season 3 — Пиратские острова (Obsidian / great_khan)
  {
    ...
    nameUk: 'Адмірал привидів',
    nameKa: 'Ghost Admiral',
    nameAz: 'Xəyal Admiralı',
    nameUz: 'Zulmat Odini',
    namePl: 'Odyn Ciemności',
  ...
  // Season 4 — Скандинавские боги (Obsidian / great_khan)
  {
    ...
    nameUk: 'Одін Темряви',
    nameKa: 'Odin of Darkness',
    nameAz: 'Qaranlığın Odini',
    nameUz: 'Boʻshliq Imperatori',
    namePl: 'Cesarz Pustki',
  ...
  // Season 5 — Космическая одиссея (Obsidian / great_khan)
  {
    ...
    nameEn: 'Void Emperor',
    nameUk: 'Повелитель порожнечі',
    nameKa: 'Void Emperor',
    nameAz: 'Boşluq İmperatoru',
    nameUz: 'Netrunner Hukmdori',
    namePl: 'Władca Netrunnera',
  ...
  // Season 10 — Киберпанк (Obsidian / great_khan)
  {
    ...
    nameUk: 'Повелитель мережі',
    nameKa: 'Netrunner Overlord',
    nameAz: 'Netrunner Hökmdarı',
    nameUz: 'Soya MC',
    namePl: 'Cień MC',
  ...
  // Season 12 — Ангелы и Демоны (Obsidian / great_khan)
  {
    ...
    nameUk: 'Верховний арбітр',
    nameKa: 'Supreme Arbiter',
    nameAz: 'Ali Hakim',
    nameUz: 'Dasht Yoquti',
    namePl: 'Stepowy Rubin',
  ...
  // Season 6 — Казахский колорит (Ruby)
  {
    ...
    nameKk: 'Дала рубині',
    nameEn: 'Steppe Ruby',
    nameUk: 'Степовий рубін',
    nameKa: 'Steppe Ruby',
    nameAz: 'Çöl Yaqutu',
    nameUz: 'Neon Yoqut',
    namePl: 'Neonowy Rubin',
    url: 'ruby_kazakh',
  ...
  // Season 7 — Неоновая эра (Ruby)
  {
    ...
    nameKk: 'Неон рубині',
    nameEn: 'Neon Ruby',
    nameUk: 'Неоновий рубін',
    nameKa: 'Neon Ruby',
    nameAz: 'Neon Yaqutu',
    nameUz: 'Apokalipsis Yoquti',
    namePl: 'Apokaliptyczny Rubin',
    url: 'ruby_neon_era',
  ...
  // Season 8 — Апокалипсис (Ruby)
  {
    ...
    nameUk: 'Рубін апокаліпсису',
    nameKa: 'Apocalypse Ruby',
    nameAz: 'Apokalipsis Yaqutu',
    nameUz: 'Sakura Yoquti',
    namePl: 'Sakurowy Rubin',
    url: 'ruby_apocalypse',
  ...
  // Season 9 — Японские мотивы (Ruby)
  {
    ...
    nameUk: 'Рубін сакури',
    nameKa: 'Sakura Ruby',
    nameAz: 'Sakura Yaqutu',
    nameUz: 'Dasht Qahrabo',
    namePl: 'Stepowy Bursztyn',
    url: 'ruby_japanese',
  ...
  // Season 6 — Казахский колорит (Amber)
  {
    ...
    nameKk: 'Дала янтары',
    nameEn: 'Steppe Amber',
    nameUk: 'Степовий бурштин',
    nameKa: 'Steppe Amber',
    nameAz: 'Çöl Kəhrəbası',
    nameUz: 'Neon Qahrabo',
    namePl: 'Neonowy Bursztyn',
    url: 'amber_kazakh',
  ...
  // Season 7 — Неоновая эра (Amber)
  {
    ...
    nameKk: 'Неон янтары',
    nameEn: 'Neon Amber',
    nameUk: 'Неоновий бурштин',
    nameKa: 'Neon Amber',
    nameAz: 'Neon Kəhrəbası',
    nameUz: 'Apokalipsis Qahrabo',
    namePl: 'Apokaliptyczny Bursztyn',
    url: 'amber_neon_era',
  ...
  // Season 8 — Апокалипсис (Amber)
  {
    ...
    nameUk: 'Бурштин апокаліпсису',
    nameKa: 'Apocalypse Amber',
    nameAz: 'Apokalipsis Kəhrəbası',
    nameUz: 'Sakura Qahrabo',
    namePl: 'Sakurowy Bursztyn',
  ...
  // Season 9 — Японские мотивы (Amber)
  {
    ...
    nameEn: 'Sakura Amber',
    nameUk: 'Бурштин сакури',
    nameKa: 'Sakura Amber',
    nameAz: 'Sakura Kəhrəbası',
    nameUz: 'Dasht Obsidiani',
    namePl: 'Stepowy Obsydian',
    url: 'amber_japanese',
  ...
  // Season 6 — Казахский колорит (Obsidian)
  {
    ...
    nameUk: 'Степовий обсидіан',
    nameKa: 'Steppe Obsidian',
    nameAz: 'Çöl Obsidianı',
    nameUz: 'Neon Obsidiani',
    namePl: 'Neonowy Obsydian',
    url: 'obsidian_kazakh',
  ...
  // Season 7 — Неоновая эра (Obsidian)
  {
    ...
    nameUk: 'Неоновий обсидіан',
    nameKa: 'Neon Obsidian',
    nameAz: 'Neon Obsidianı',
    nameUz: 'Apokalipsis Obsidiani',
    namePl: 'Apokaliptyczny Obsydian',
  ...
  // Season 8 — Апокалипсис (Obsidian)
  {
    ...
    nameUk: 'Обсидіан апокаліпсису',
    nameKa: 'Apocalypse Obsidian',
    nameAz: 'Apokalipsis Obsidianı',
    nameUz: 'Sakura Obsidiani',
    namePl: 'Sakurowy Obsydian',
  ...
  // Season 9 — Японские мотивы (Obsidian)
  {
    ...
    nameUk: 'Обсидіан сакури',
    nameKa: 'Sakura Obsidian',
    nameAz: 'Sakura Obsidianı',
    nameUz: 'Neon Toj',
    namePl: 'Neonowa Korona',
...

  {
    ...
    nameKk: 'Неон Таж',
    nameEn: 'Neon Crown',
    nameUk: 'Неонова корона',
    nameKa: 'Neon Crown',
    nameAz: 'Neon Tacı',
    nameUz: 'Oq Tulki (Kitsune)',
    namePl: 'Biały Lis (Kitsune)',
    url: 'neon_crown',
  ...
  },
  {
    ...
    nameUk: 'Біла лисиця (Кіцуне)',
    nameKa: 'White Fox (Kitsune)',
    nameAz: 'Ağ Tülkü (Kitsune)',
    nameUz: 'Ajdaho (Ryu)',
    namePl: 'Smok (Ryu)',
  ...
  },
  {
    ...
    nameKa: 'VIP',
    nameAz: 'VIP',
    nameUz: 'Magʻrur Tulki',
    namePl: 'Zarozumiały Lis',
  ...
  },
  {
    ...
    nameUk: 'Хитра лисиця',
    nameKa: 'Smug Fox',
    nameAz: 'Özündən Razı Tülkü',
    nameUz: 'Gʻazablangan Ayiq',
    namePl: 'Zły Niedźwiedź',
    url: '/assets/avatars/avatar_fox_smug-fJkNAyA3ddNsq2NQbDnhxF.webp',
    premium: true,
    price: 50,
  },
  {
    ...
    nameKa: 'Angry Bear',
    nameAz: 'Qəzəbli Ayı',
    nameUz: 'Dono Boyoʻgʻli',
    namePl: 'Mądra Sowa',
    url: '/assets/avatars/avatar_bear_angry-BgGpArBiGaongtJtNqPrPP.webp',
    premium: true,
    price: 50,
  },
  {
    ...
    nameUk: 'Мудра сова',
    nameKa: 'Wise Owl',
    nameAz: 'Müdrik Bayquş',
    nameUz: 'Dangasa Mushuk',
    namePl: 'Leniwy Kot',
    url: '/assets/avatars/avatar_owl_wise-YmXBTYp2RGoRCkSjUGkKLs.webp',
    premium: true,
    price: 50,
  },
  {
    ...
    nameKa: 'Lazy Cat',
    nameAz: 'Tənbəl Pişik',
    nameUz: 'Shiddatli Boʻri',
    namePl: 'Dziki Wilk',
    url: '/assets/avatars/avatar_cat_lazy-4fa5o8JrJbsoGukvmiRYck.webp',
    premium: true,
    price: 50,
  },
  {
    ...
    nameUk: 'Лютий вовк',
    nameKa: 'Fierce Wolf',
    nameAz: 'Yırtıcı Canavar',
    nameUz: 'Magʻrur Yoʻlbars',
    namePl: 'Dumny Tygrys',
    url: '/assets/avatars/avatar_wolf_fierce-jxRuqcVyJiD2VL2nhXrK9b.webp',
    premium: true,
    price: 50,
  },
  {
    ...
    nameUk: 'Гордий тигр',
    nameKa: 'Proud Tiger',
    nameAz: 'Qürurlu Pələng',
    nameUz: 'Baxtli Panda',
    namePl: 'Szczęśliwa Panda',
    url: '/assets/avatars/avatar_tiger_proud-33ax6W3gWEbAUXyPmFNsEK.webp',
    premium: true,
    price: 50,
  },
  {
    ...
    nameUk: 'Весела панда',
    nameKa: 'Happy Panda',
    nameAz: 'Xoşbəxt Panda',
    nameUz: 'Burgut',
    namePl: 'Orzeł',
    url: '/assets/avatars/avatar_panda_happy-kPPArBc2zvKGbib5i2GzFS.webp',
    premium: true,
    price: 50,
  },
  {
    ...
    nameUz: 'Qor Qoploni',
    namePl: 'Śnieżny Lampart',
    url: '/assets/avatars/avatar_eagle_determined-gks9AN9EiDq2fM34wDAitN.webp',
    premium: true,
    price: 50,
  },
  {
    ...
    nameKa: 'Snow Leopard',
    nameAz: 'Sakit Bəbir',
    nameUz: 'Hiylagar Yenot',
    namePl: 'Psotny Szop',
    url: '/assets/avatars/avatar_snow_leopard_calm-jfAGUjmLVzuYTVxYKyPMAd.webp',
    premium: true,
    price: 50,
  },
  {
    ...
    nameUk: 'Хуліган єнот',
    nameKa: 'Mischievous Raccoon',
    nameAz: 'Yaramaz Yenot',
    url: '/assets/avatars/avatar_raccoon_mischievous-aAdKvfGW7K3WLV8SdDhLPL.webp',
    premium: true,
    price: 50,
  },
];
